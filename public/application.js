...
/***/ (function(module, exports, __webpack_require__) {
	...
	var cardEvents = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetCards = function onGetCards(event) {
	  event.preventDefault();
	  api.getCards().then(ui.getCardsSuccess).catch(ui.getCardsFailure);
	};

	var onCreateCard = function onCreateCard(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createCard(data).then(ui.createCardSuccess).then(function () {
	    api.getCards(data).then(ui.getCardsSuccess).catch(ui.getCardsFailure);
	...
	var onDeleteCard = function onDeleteCard(event) {
	  ...
	  api.deleteCard(data).then(ui.deleteCardSuccess).then(function () {
	    api.getCards(data).then(ui.getCardsSuccess).catch(ui.getCardsFailure);
	...
	var onUpdateCard = function onUpdateCard(event) {
	  ...
	  var data = getFormFields(event.target);
	  data.card.id = id;
	  api.updateCard(data).then(ui.updateCardSuccess).then(function () {
	    api.getCards(data).then(ui.getCardsSuccess).catch(ui.getCardsFailure);
	  }).catch(ui.updateCardFailure);
	};

	var onUpdateClose = function onUpdateClose(event) {
	  onGetCards();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteCard = function deleteCard(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getCardsTemplate = __webpack_require__(16);

	var getCardsSuccess = function getCardsSuccess(response) {
	  var content = getCardsTemplate({ cards: response.cards });
	  $('.content').html(content);
	  $('#blurb').hide();
	};

	var getCardsFailure = function getCardsFailure() {};

	var createCardSuccess = function createCardSuccess(data) {
	...
	var createCardFailure = function createCardFailure() {};

	var deleteCardSuccess = function deleteCardSuccess(data) {};

	var deleteCardFailure = function deleteCardFailure() {};

	var updateCardSuccess = function updateCardSuccess(data) {
	  $('.update-card-modal').modal('hide');
	  $('body').removeClass('modal-open');
	  $('.modal-backdrop').remove();
	};

	var updateCardFailure = function updateCardFailure() {};

	module.exports = {
	  getCardsSuccess: getCardsSuccess,
	  getCardsFailure: getCardsFailure,
	  createCardSuccess: createCardSuccess,
	  createCardFailure: createCardFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + "\" class=\"card-row\">\n        <td contenteditable=\"false\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.website : stack1), depth0))
	    + "</td>\n        <td contenteditable=\"false\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.password : stack1), depth0))
	    + "</td>\n        <td>\n          <button class=\"btn btn-default update-btn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"\n          data-toggle=\"modal\" data-target=\"#updateCard-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <span class=\"glyphicon glyphicon-pencil\"></span>\n          </button>\n          <!-- Update Card Modal -->\n          <div class=\"modal fade\" id=\"updateCard-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-card-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n            <div class=\"modal-dialog\" role=\"document\">\n              <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                  <button type=\"button\" class=\"close updateclose\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"update-card-modal-label\">Update</h4>\n                </div>\n                <div class=\"modal-body\">\n                  <form class=\"card-form-update\" id=\"card-form-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <div class=\"form-group\">\n                      <input type=\"text\" name=\"card[website]\" id=\"website-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.website : stack1), depth0))
	    + "\" placeholder=\"Website\" required>\n                      <input type=\"text\" name=\"card[email]\" id=\"email-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.email : stack1), depth0))
	    + "\" placeholder=\"Email\">\n                      <input type=\"text\" name=\"card[password]\" id=\"password-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.password : stack1), depth0))
	    + "\" placeholder=\"Password\">\n                      <input type=\"submit\" name=\"submit\" value=\"Update Info\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"submit-update-button\">\n                    </div>\n                  </form>\n                </div>\n              </div>\n            </div>\n          </div>\n        <!-- </td>\n        <td> -->\n        <form class=\"destroy\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <fieldset>\n        <input type=\"submit\" name=\"submit\" value=\"Delete\">\n      </fieldset>\n    </form>\n        </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<div class=\"rest-listing\">\n<table class=\"table table-striped table-hover header-fixed\">\n\n  <thead>\n    <tr>\n      <th>Website</th>\n      <th>Email</th>\n      <th>Password</th>\n    </tr>\n  </thead>\n\n    <tbody>\n"
